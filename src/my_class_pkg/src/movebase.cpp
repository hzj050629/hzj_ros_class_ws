...
int main(int argc, char **argv)
{
    ...
    quaternion.setRPY(0, 0, 1.608383)// 最后一个数对应 yaw 角，正前方向量顺时针旋转
    goal1.target_pose.pose.position.x = 2.599659; //x，相对于建图起点前后的值，前正后负
    goal1.target_pose.pose.position.y = 1.715139; //y，相对于建图起点左右的值，左正右负
    ...
    quaternion.setRPY(0, 0, -1.594326); // 最后一个数对应 yaw 角，正前方向量顺时针旋转
    goal2.target_pose.pose.position.x = 2.608559;
    goal2.target_pose.pose.position.y = 3.128346;
    ...
    goal3.target_pose.pose.position.x = -0.54430;
    goal3.target_pose.pose.position.y = 2.357169;
