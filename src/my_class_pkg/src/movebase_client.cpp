...
int main(int argc, char **argv)
{
    ...
    quaternion.setRPY(0, 0, -1.582748); // 最后一个数对应 yaw 角，正前方向量顺时针旋转
    goal1.target_pose.pose.position.x = 1.771273; //x，相对于建图起点前后的值，前正后负
    goal1.target_pose.pose.position.y = -1.157379; //y，相对于建图起点左右的值，左正右负
    ...
    quaternion.setRPY(0, 0, -1.474790); // 最后一个数对应 yaw 角，正前方向量顺时针旋转
    goal2.target_pose.pose.position.x = 0.439060;
    goal2.target_pose.pose.position.y = -1.702525;
